    ...
    <div class="card">
       ...
       <form action="" method="POST" enctype="multipart/form-data">
          <div class="card-body">
            ...
            <div class="form-group">
                <label>Kelas</label>
                <input type="text" name="kelas" class="form-control" value="{{ $user->kelas }}" readonly/>
                @if($errors->has('kelas'))
                   {{ $errors->first('kelas') }}
                @endif
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="nomor_telepon" class="form-control" value="{{ $user->nomor_telepon }}" readonly/>
             ...
             <div class="form-group mb-0">
                <div class="row px-3 align-items-center justify-content-end">
                    ...
                    @elseif (Auth::guard('guru')->check())
                        <a href="{{ route('guru.user.index') }}" class="btn btn-secondary">Kembali</a>
                    @endif
                </div>
             </div>
          </div>
